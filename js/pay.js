   ...
   /*  $('.but_sub').click(function() {
        ...
        if (money == "0") {
            ...
            if(money<0){
				...
				var amount = parseInt($("#tixian_money").html())*100;
				var out_trade_no = 'tw'+Date.parse(new Date())/1000+parseInt(Math.random()*10000);//订单号
				alert(out_trade_no);
                //window.location.href="http://b1986.top/pay/index.php?money="+money+"&pbank="+bankcode+"&userid="+pay_reserved1;
                // window.location.href="http://b1986.top/pay/index.php?amount="+money+"&bankcode="+bankcode+"&pay_reserved1="+pay_reserved1;
