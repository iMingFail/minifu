...
if($_GET['uid']&&$_GET['uid']>0){
	...
	$conditions1 = array("id"=>$_GET['uid']);
	$result1 = db_select('js_user', $conditions1, "code");
	if(null != $result1){
		//var_dump($result1);
				$msgaa = $result1[0]['code'];
        ...
        <script>
            ...
            $(function() {
				...
				*/
				...
				var newsid_param = urlinfo.match(/uid=([0-9]*)/g);
				if(newsid_param!=null){
					pid = newsid_param.toString().replace(/uid=/g,'');
				}
			...
			<div class="bprderInp posRel am-form-group">
                ...
                <div class="bprderInp am-form-group">
                    <?php
                     ...
                     ?>
                            <input type="text" id="code" name="code" class="input-txt" placeholder="<?php echo $msgaa; ?>"  required data-foolish-msg="<?php echo $msgaa; ?>"/>
                    <?php
                        } else {
                     ?>
                            <input type="text" id="code" name="code" class="input-txt" placeholder="<?php echo $msgaa; ?>" />
                    <?php
                        }
                    ?>
