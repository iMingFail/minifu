        ...
        <div class="admin-content-body">
            <div class="am-cf am-padding am-padding-bottom-0">
                <div class="am-fl am-cf">
                    <strong class="am-text-primary am-text-lg"> 充值卡管理</strong> / <small>列表</small>
                </div>
            </div>
            <hr>
            <div class="am-g">
                <div class="am-u-sm-12 am-u-md-6">
                    <div class="am-btn-toolbar">
                        <div class="am-btn-group am-btn-group-xs">
                            <a href="top_up_operate.php" type="button" class="am-btn am-btn-default"><span class="am-icon-plus"></span> 生成充值卡</a>
            ...
            <div class="am-g">
                <div class="am-u-sm-12">
                    <table class="am-table am-table-striped am-table-hover table-main" id="doc-modal-list">
                        ...
                        <?php
                        $conditions = array();
                        $params = "id,number,password,money,state,datetime";
                        $limit = "limit ".($pageNo-1)*$pageSize.", $pageSize";
                        $result = db_select("js_top_up", $conditions, $params, $limit, array("datetime"=>"desc"));
                    ...
                    <div class="am-cf">
                        <?php
                        $result_count = db_select("js_top_up", $conditions, "count(id) total");
                        ...
                        <div class="am-btn-toolbar am-fr">
                            <div class="am-btn-group am-btn-group-sm">
                                ...
                                //生成页码
                                $pageViewString = $p->echoPageAsDiv("top_up.php");
                                echo $pageViewString;
                                ?>
                            </div>
                        </div>
...
<script>
    ...
    function del(ids) {
        ...
        $.ajax({
            type:"POST",
            url:"api/api.php?t=t&action=delete",
            dataType:"json",
            data:{ids:ids},
            beforeSend:function(){
                loading("正在操作...");
