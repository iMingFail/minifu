            ...
            <div class="am-g">
                <div class="am-u-sm-12">
                    <table class="am-table am-table-striped am-table-hover table-main" id="doc-modal-list">
                        ...
                        <tbody>
                        <?php
                        $conditions = array("a.type"=>$type, "a.state != 0"=>"");
                        $params = "a.money, a.state, a.datetime, b.mobilePhone,b.realName,a.type,a.cz";
                        ...
                        if(!empty($result) && count($result) > 0) {
                            for ($i=0;$i<count($result);$i++) {
                                ...
                                ?>
                                <tr>
                                    <td><?php echo $type_str;if($result[$i]["type"]=='1'){?>(<?php if($result[$i]["cz"]=='1'){ echo "<i style='color:blue;'>后台</i>";}else{ echo "<i style='color:green;'>用户</i>";}?>)<?php }?></td>
