                ...
                <ul class="am-tabs-nav am-nav am-nav-tabs">
                    <?php
                        if ($uid != "0") {
                            ...
                            <li <?php if($tab == 2) { echo "class=\"am-active\""; } ?>><a href="#tab2">团队</a></li>
                        ...
                        if(empty($result_c)) {
                            ...
                            <table class="am-table am-table-striped am-table-hover table-main">
                                ...
                                for($i=0; $i<count($my_result_rebate); $i++) {
                                    ...
                                    $user_c = db_execute_select("select insert(mobilePhone,4,4,'****') mobilePhone, realName from js_user where id=".$my_result_rebate[$i]["userId"]);
                                    $realName = "未认证用户";
                ...
                if (this.isFormValid()) {
                    ...
                    switch(action) {
                        ...
                        case "edit":
                            ...
                            var uid = $("#uid_txt").val();
                            data = {"identity":identity, "realName":realName, "nickName":nickName, "sex":sex, "uid":uid, "password":password};
                            break;
                    }
                    $.ajax({
                        type:"POST",
