        ...
        <div class="admin-content-body">
            <div class="am-cf am-padding am-padding-bottom-0">
                <div class="am-fl am-cf">
                    <strong class="am-text-primary am-text-lg"><a href="rebate_setting.php">赠送代金劵</a></strong>
                </div>
            </div>
            <hr>
            <div class="am-tabs am-margin">
                <ul class="am-tabs-nav am-nav am-nav-tabs">
                <li class="am-active"><a href="#tab1">赠送代金劵</a></li>
            </ul>
                ...
                <div class="am-tab-panel am-fade am-active am-in" id="tab1">
                    <fieldset>
                        <form class="am-form user-info-form">
                            ...
                            <div class="am-form-group">
                                <label for="doc-vld-age-2">赠送数量：</label>
                                <input type="text" id="num"  placeholder="输入生成数量"/>
                            </div>
                        </form>
                        <div class="am-margin"><button class="am-btn am-btn-secondary confirmBtn" type="button">赠送</button></div>
                    </fieldset>
                </div>
            </div>
        </div>
        ...
        $(".user-info-form").validator({
            submit:function(){
                if (this.isFormValid()) {
                    $.ajax({
                        type:"POST",
                        url:"api/api.php?t=v&action="+action,
                        dataType:"json",
                        data:{"money":$("#money").val(), "num":$("#num").val(), "user_id":$("#user_id").val()},
                        beforeSend:function(){
                            loading("正在生成代金劵...");
                        },
