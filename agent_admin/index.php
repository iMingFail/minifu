<?php
    ...
    $uid = $_SESSION["agent_admin"]['id'];
    
    $conditions = array("pid" => $uid);
    $result_c = db_select('js_user', $conditions, "id,insert(mobilePhone,4,4,'****') mobilePhone,realName");
  ...
  <div class="admin-content">
    <div class="admin-content-body">
      ...
      <ul class="am-avg-sm-1 am-avg-md-4 am-margin am-padding am-text-center admin-content-list ">
          <li style="    height: 30px;line-height: 30px;"><a href="#" class="am-text-warning">团队总人数<?php echo count($result_c)?>个</a></li>
          <li style="    height: 30px;line-height: 30px;"><a href="#" class="am-text-secondary">团队返利<?php echo $rebate_money?>元</a></li>
          <!-- <li style="    height: 30px;line-height: 30px;"><a href="#" class="am-text-success">今日成交量<?php echo $today_order_num?></a></li>
          <li style="    height: 30px;line-height: 30px;"><a href="#" class="am-text-danger">历史成交量<?php echo $all_order_num?></a></li>
          <li style="    height: 30px;line-height: 30px;"><a href="#" class="am-text-warning">今日盈利<?php echo $today_gain?>元</a></li>
          <li style="    height: 30px;line-height: 30px;"><a href="#" class="am-text-secondary">历史盈利<?php echo $all_gain?>元</a></li>
          <li style="    height: 30px;line-height: 30px;"><a href="#" class="am-text-success">今日成交量<?php echo $today_order_num?></a></li>
          <li style="    height: 30px;line-height: 30px;"><a href="#" class="am-text-danger">历史成交量<?php echo $all_order_num?></a></li> -->
      </ul>
      <!--div class="am-g">
