<?php
    ...
    $admin_id = $_SESSION["agent_admin"]["id"];
    ...
    <div class="admin-content">
        <div class="admin-content-body">
            <div class="am-cf am-padding am-padding-bottom-0">
                <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">管理员管理</strong> / <small>列表</small></div>
            </div>
            <hr>
            <div class="am-g">
                <div class="am-u-sm-12 am-u-md-6">
                    <div class="am-btn-toolbar">
                        <div class="am-btn-group am-btn-group-xs">
                            <a href="admin_operate.php?action=add" type="button" class="am-btn am-btn-default"><span class="am-icon-plus"></span> 新增</a>
                    ...
                    <form class="am-form">
                        <table class="am-table am-table-striped am-table-hover table-main" id="doc-modal-list">
                            ...
                            <tr>
                                ...
                                <th>ID</th><th>登录帐号</th><th>名称</th><th>操作</th>
                            </tr>
                            </thead>
                            <tbody>
                            <?php
                                $conditions = array("id != $admin_id"=>"");
                                ...
                                if ($result != null && count($result) > 0) {
                                    for ($i = 0; $i < count($result); $i++) {
                                        ...
                                        <tr data-id="<?php echo $result[$i]["id"]?>">
                                            ...
                                            <td><?php echo $result[$i]["loginName"]?></td>
                                            <td><?php echo $result[$i]["name"]?></td>
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
                                                        <a href="admin_operate.php?action=edit&id=<?php echo $result[$i]["id"] ?>" style="background-color:#ffffff;" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-info"></span> 详情</a>
...
<script>
    ...
    function del(ids) {
        ...
        $.ajax({
            type:"POST",
            url:"api/api.php?t=m&action=del",
            dataType:"json",
            data:{ids:ids},
            beforeSend:function(){
                loading("正在操作...");
