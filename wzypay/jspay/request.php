...
Class Request{
    ...
    public function submitOrderInfo(){
        ...
        //通知地址，必填项
		$this->reqHandler->setParameter('notify_url','http://'.$_SERVER['SERVER_NAME'].'/pay/jspay/pay.php');//通知回调地址，目前默认是空格，商户在测试支付和上线时必须改为自己的，且保证外网能访问到
        ...
        if($this->pay->call()){
			...
			//file_put_contents("res.txt",$res['pay_info']);
