	...
	$('.but_sub').click(function() {
        ...
        if (money == "0") {
            ...
            if(money<0){
                ...
                window.location.href="http://"+window.location.host+"/pay/jspay/index.php?money="+money+"&userid="+pay_reserved1;
            } 
        }
    });
    ...
    $(document).ready(function(){
        ...
        $('#pay_platform').delegate('span','click',function(e){
            ...
            var mask = $('<div class="mask"></div>');
                $('body').append(mask);
            $.post('/pay/jspay/request.php',param,function(res){
                ...
                if(res.status === 500){
                    ...
                    if(curPage === 'orderInfo'){
						// $sql="INSERT INTO  `js_balance_log` (  `userId` ,  `order_code` ,  `out_trade_no` ,  `type` ,  `money` ,  `give_money` ,  `state` ,  `datetime` ) 
							// VALUES ('$userid',1,  '1',  '1',  '$money',  0, 1, NOW( ))";
						// db_execute($sql);
                        window.location.href='/pay/jspay?token_id='+res.token_id+'&showwxtitle=1';
						// $('body').popUpWin({
